        ...
        >
          ...
          <div className="glass-card p-8">
              ...
              {isLogin && (
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" className="w-3.5 h-3.5 rounded border-white/10 bg-[#151d35]" defaultChecked />
                    <span className="text-xs text-[#94a3c8]">Remember me</span>
                  </label>
                  <button type="button" className="text-xs text-[#4361ee] hover:underline">Forgot password?</button>
                </div>
              )}
            ...
            <div className="flex items-center gap-4 my-6">
              ...
              <span className="text-xs text-[#5a6a8a]">or continue with</span>
              <div className="flex-1 h-px bg-white/[0.06]" />
            </div>

            {/* OAuth Buttons */}
            <div className="grid grid-cols-2 gap-3">
              <button className="btn-secondary !py-2.5 flex items-center justify-center gap-2 text-xs">
